...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b backdrop-blur-md navbar">
            ...
            <div className="hidden sm:flex items-center gap-1">
              {[
                ...
                <Link
                  key={path}
                  to={path}
                  className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${isActive(path)
                    ? 'bg-teal-500/15 text-teal-500'
                    : 'hover:bg-teal-500/10'
                    }`}
                  style={{
                    color: isActive(path) ? undefined : 'var(--text-muted)',
                  }}
                >
                  {icon}
                  {label}
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  background: isDark ? '#94a3b8' : '#fbbf24',
                }}
              >
                {isDark ? (
            ...
            {user ? (
              <>
                <Link
                  to="/profile"
                  className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-colors hover:bg-teal-500/10"
