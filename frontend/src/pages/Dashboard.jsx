    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="mb-10 animate-fade-up">
        ...
        <p className="mt-1" style={{ color: 'var(--text-muted)' }}>
          What can MediAI help you with today?
        </p>
      </div>
      ...
      <div className="grid sm:grid-cols-2 gap-5 mb-10">
        <Link
          to="/triage"
          className="card p-6 hover:border-teal-500/40 transition-all duration-300 group animate-fade-up stagger-1 block"
        >
        ...
        <Link
          to="/prescription"
          className="card p-6 hover:border-teal-500/40 transition-all duration-300 group animate-fade-up stagger-2 block"
        >
          <div className="flex items-start justify-between mb-4">
            <div
              className="w-12 h-12 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform"
        ...
        <div className="grid grid-cols-3 gap-4 mb-10 animate-fade-up stagger-3">
          {[
            ...
            <div key={i} className="card p-5 text-center">
              <div
                className="flex items-center justify-center gap-1.5 text-xs mb-2"
      ...
      <div className="animate-fade-up stagger-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/history" className="text-sm font-medium" style={{ color: 'var(--accent)' }}>
            View all →
          </Link>
        </div>
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {dashboard.recent.map((item, i) => (
              ...
              >
                ...
                {item.risk_level && (
                  <span className={riskColors[item.risk_level] || 'badge-low'}>
                    {item.risk_level}
                  </span>
                )}
              </Link>
          ...
          <div className="card p-10 text-center">
            <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
              No activity yet. Start with a symptom check or prescription explanation.
            </p>
