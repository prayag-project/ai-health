  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10 space-y-5">
            ...
            {result.conditions.map((cond, i) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <span
                    className="w-6 h-6 rounded-full text-xs flex items-center justify-center font-mono flex-shrink-0 mt-0.5"
                    style={{
      ...
      {result.doctor_recommendation && (
        <div
          className="card p-5 animate-fade-up stagger-4"
      ...
      >
        <p className="text-xs leading-relaxed" style={{ color: 'var(--text-muted)' }}>
          ⚠️ <strong style={{ color: 'var(--text)' }}>Medical Disclaimer:</strong> This analysis is for educational purposes only and does not constitute a medical diagnosis. Always consult a qualified healthcare professional for proper diagnosis and treatment.
        </p>
      </div>
